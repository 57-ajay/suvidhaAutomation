...
async def amain(job_id: str, display: str) -> None:
    ...
    try:
        ...
        if task_id == "puc-certificate":
            ...
            #
            # The Firestore target is subChallanRequests/{requestId}, where
            # requestId is the client's autogenerated doc id (NOT the challan
            # number). The status-update payload already carries it, so there
            # is nothing extra to plumb through.
            ...
            if path == "scripted":
                ...
                from config import SCRIPTED_POPUP_MAX_ATTEMPTS
