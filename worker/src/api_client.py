...
async def save_challan_receipt(
    *,
    ...
    The API writes subChallanRequests/{request_id} — aiAgentStatus.{status:
    ...
    never land separately. request_id is the autogenerated doc id and the ONLY
    thing that addresses the write; challan_no and vehicle_number just shape
    the receipt's GCS path and its object metadata.
