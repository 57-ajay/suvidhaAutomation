...
async def status_update(
    *, request_id: str, driver_id: str, status: str, source: str = "app",
    ...
    return await _post("/api/internal/status-update", {
...
async def save_captcha(
    *, request_id: str, driver_id: str, image_base64: str, attempt: int,
    max_attempts: int, wait_seconds: int,
) -> dict:
    return await _post("/api/internal/save-captcha", {
        "requestId": request_id,
        "driverId": driver_id,
...
async def captcha_result(
    *, request_id: str, driver_id: str, result: str, attempt: int,
) -> dict:
    return await _post("/api/internal/captcha-result", {
        "requestId": request_id,
        "driverId": driver_id,
        "result": result,
        "attempt": attempt,
...
async def save_qr(
    *, request_id: str, driver_id: str, vehicle_number: str, image_base64: str,
    ...
    return await _post("/api/internal/save-qr", {
        "requestId": request_id,
        "driverId": driver_id,
...
async def save_receipt(
    *, request_id: str, driver_id: str, pdf_base64: str | None = None,
    image_base64: str | None = None, fields: dict | None = None,
) -> dict:
    return await _post("/api/internal/save-receipt", {
        "requestId": request_id,
        "driverId": driver_id,
...
async def job_completed(
    *, job_id: str, request_id: str, driver_id: str, status: str,
    ...
    return await _post("/api/internal/job-completed", {
        "jobId": job_id,
        "requestId": request_id,
        "driverId": driver_id,
        "status": status,
